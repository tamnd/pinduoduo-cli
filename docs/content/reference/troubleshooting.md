...
Most of these come down to network reality or how pinduoduo serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

pinduoduo rate-limits like any public site. pdd already paces
...
Where a surface is gated, pdd reads a cookie or token you supply
...
`pdd`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what pdd actually did
